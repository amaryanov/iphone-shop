...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.11 2008-08-27 08:58:29 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE__ns1__helloResponse:
		if (p->size < 0)
			delete (_ns1__helloResponse*)p->ptr;
		else
			delete[] (_ns1__helloResponse*)p->ptr;
		break;
	case SOAP_TYPE_ns2__MBusinessCard:
	...
	case SOAP_TYPE___ns3__hello:
		if (p->size < 0)
			delete (struct __ns3__hello*)p->ptr;
		else
			delete[] (struct __ns3__hello*)p->ptr;
		break;
	case SOAP_TYPE___ns3__getCategoryList:
	...
	case SOAP_TYPE___ns4__hello:
		if (p->size < 0)
			delete (struct __ns4__hello*)p->ptr;
		else
			delete[] (struct __ns4__hello*)p->ptr;
		break;
	case SOAP_TYPE___ns4__getCategoryList:
...
{
	this->soap = soap;
	this->_ns1__helloResponse::return_ = NULL;
...
{
	(void)soap; /* appease -Wall -Werror */
	soap_serialize_PointerTostd__string(soap, &this->_ns1__helloResponse::return_);
	/* transient soap skipped */
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out__ns1__helloResponse(struct soap *soap, const char *tag, int id, const _ns1__helloResponse *a, const char *type)
{
	...
	if (soap_out_PointerTostd__string(soap, "ns1:return", -1, &(a->_ns1__helloResponse::return_), "xsd:string"))
		return soap->error;
	/* transient soap skipped */
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_return_1 && (soap->error == SOAP_TAG_MISMATCH || soap->error == SOAP_NO_TAG))
				if (soap_in_PointerTostd__string(soap, "ns1:return", &(a->_ns1__helloResponse::return_), "xsd:string"))
				{	soap_flag_return_1--;
					continue;
				}
			/* transient soap skipped */
...
SOAP_FMAC5 _ns1__helloResponse * SOAP_FMAC6 soap_new__ns1__helloResponse(struct soap *soap, int n)
{	return soap_instantiate__ns1__helloResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete__ns1__helloResponse(struct soap *soap, _ns1__helloResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 _ns1__helloResponse * SOAP_FMAC4 soap_instantiate__ns1__helloResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new _ns1__helloResponse;
		if (size)
			*size = sizeof(_ns1__helloResponse);
		((_ns1__helloResponse*)cp->ptr)->soap = soap;
	}
	else
	{	cp->ptr = (void*)new _ns1__helloResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
void ns2__MDetailedProduct::soap_default(struct soap *soap)
{
	...
	this->ns2__MDetailedProduct::offers = NULL;
...
void ns2__MDetailedProduct::soap_serialize(struct soap *soap) const
{
	...
	soap_serialize_PointerToxsd__anyType(soap, &this->ns2__MDetailedProduct::offers);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns2__MDetailedProduct(struct soap *soap, const char *tag, int id, const ns2__MDetailedProduct *a, const char *type)
{
	...
	if (soap_out_PointerTostd__string(soap, "ns2:amazonURL", -1, &(a->ns2__MDetailedProduct::amazonURL), "xsd:string"))
		return soap->error;
	if (soap_out_PointerToxsd__anyType(soap, "ns2:offers", -1, &(a->ns2__MDetailedProduct::offers), "xsd:anyType"))
		return soap->error;
...
SOAP_FMAC3 ns2__MDetailedProduct * SOAP_FMAC4 soap_in_ns2__MDetailedProduct(struct soap *soap, const char *tag, ns2__MDetailedProduct *a, const char *type)
{
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_offers1 && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToxsd__anyType(soap, "ns2:offers", &(a->ns2__MDetailedProduct::offers), "xsd:anyType"))
				{	soap_flag_offers1--;
					continue;
				}
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__MContactInfo), "ns2:MContactInfo"))
		return soap->error;
	/* transient soap skipped */
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__MAddress), "ns2:MAddress"))
		return soap->error;
	/* transient soap skipped */
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__MCategory), "ns2:MCategory"))
		return soap->error;
	/* transient soap skipped */
...
{
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns2__MItem), "ns2:MItem"))
		return soap->error;
	/* transient soap skipped */
	if (soap_out_PointerTostd__string(soap, "ns2:highlight1", -1, &(a->ns2__MItem::highlight1), "xsd:string"))
		return soap->error;
...
SOAP_FMAC3 xsd__anyType * SOAP_FMAC4 soap_instantiate_xsd__anyType(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (type && !soap_match_tag(soap, type, "ns2:MItem"))
	{	cp->type = SOAP_TYPE_ns2__MItem;
		if (n < 0)
		{	cp->ptr = (void*)new ns2__MItem;
			if (!cp->ptr)
			{	soap->error = SOAP_EOM;
	...
	if (type && !soap_match_tag(soap, type, "ns2:MCategory"))
	{	cp->type = SOAP_TYPE_ns2__MCategory;
		if (n < 0)
		{	cp->ptr = (void*)new ns2__MCategory;
			if (!cp->ptr)
			{	soap->error = SOAP_EOM;
	...
	if (type && !soap_match_tag(soap, type, "ns2:MAddress"))
	{	cp->type = SOAP_TYPE_ns2__MAddress;
		if (n < 0)
		{	cp->ptr = (void*)new ns2__MAddress;
			if (!cp->ptr)
			{	soap->error = SOAP_EOM;
	...
	if (type && !soap_match_tag(soap, type, "ns2:MContactInfo"))
	{	cp->type = SOAP_TYPE_ns2__MContactInfo;
		if (n < 0)
		{	cp->ptr = (void*)new ns2__MContactInfo;
			if (!cp->ptr)
			{	soap->error = SOAP_EOM;
...
{
	register int id = 0;
	if (soap_out___ns4__hello(soap, tag, id, a, type))
		return soap->error;
	return SOAP_OK;
}
...
SOAP_FMAC5 struct __ns4__hello * SOAP_FMAC6 soap_new___ns4__hello(struct soap *soap, int n)
{	return soap_instantiate___ns4__hello(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete___ns4__hello(struct soap *soap, struct __ns4__hello *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct __ns4__hello * SOAP_FMAC4 soap_instantiate___ns4__hello(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct __ns4__hello;
		if (size)
			*size = sizeof(struct __ns4__hello);
	}
	else
	{	cp->ptr = (void*)new struct __ns4__hello[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC5 struct __ns3__hello * SOAP_FMAC6 soap_new___ns3__hello(struct soap *soap, int n)
{	return soap_instantiate___ns3__hello(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete___ns3__hello(struct soap *soap, struct __ns3__hello *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct __ns3__hello * SOAP_FMAC4 soap_instantiate___ns3__hello(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct __ns3__hello;
		if (size)
			*size = sizeof(struct __ns3__hello);
	}
	else
	{	cp->ptr = (void*)new struct __ns3__hello[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerTo_ns1__helloResponse(struct soap *soap, _ns1__helloResponse *const*a, const char *tag, const char *type)
{
	...
	if (soap_out_PointerTo_ns1__helloResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 xsd__anyType ** SOAP_FMAC4 soap_in_PointerToxsd__anyType(struct soap *soap, const char *tag, xsd__anyType **a, const char *type)
{
	...
	*a = NULL;
	...
	{	xsd__anyType ** p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_xsd__anyType, sizeof(xsd__anyType), 0);
		...
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MItem, sizeof(ns2__MItem), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MCategory, sizeof(ns2__MCategory), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MAddress, sizeof(ns2__MAddress), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MContactInfo, sizeof(ns2__MContactInfo), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MBusinessCard, sizeof(ns2__MBusinessCard), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MDetailedItem, sizeof(ns2__MDetailedItem), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MProduct, sizeof(ns2__MProduct), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MDetailedBusinessCard, sizeof(ns2__MDetailedBusinessCard), 0);
		}
		if (!p && soap->error == SOAP_HREF)
		{	soap->error = SOAP_OK;
			p = (xsd__anyType **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_ns2__MDetailedProduct, sizeof(ns2__MDetailedProduct), 0);
		}
		a = p;
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
